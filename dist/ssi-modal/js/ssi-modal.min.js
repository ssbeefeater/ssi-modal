...
"")+'"><span></span></div>'),g=e('<div class="ssi-modalPrev '+(1>c?"ssi-hidden":"")+'"><span></span></div>');d.append(h,g);a.get$backdrop().one("backdropClose.ssi-modal",function(){p=v=""});a.get$modal().one("beforeClose.ssi-modal",function(){d.remove()}).one("onShow.ssi-modal",function(){h.one("click",function(b){b.preventDefault();a.navigate("next");e(this).off("click.ssi_modal")});g.one("click",function(b){b.preventDefault();a.navigate("prev");e(this).off("click.ssi_modal")})});return d}}}function d(b){f.find(".ssi-loader").remove();
var c=[];if(!b&&""!==a.options.imgButtons&&!e.isEmptyObject(a.options.imgButtons)){var d=a.setButtons(a.options.imgButtons,a.get$content()).addClass("ssi-imgButtons");!0===a.options.hideImgButtons&&(d.addClass("ssi-navFade ssi-navFadeOut"),a.get$wrapper().mouseover(function(){d.addClass("ssi-navFadeIn")}).mouseleave(function(){d.removeClass("ssi-navFadeIn")}));c.push(d)}c.push(n);f.append(c)}function h(b,c){clearInterval(B);var e=b||(w?n[0].naturalWidth:n.width()),h=c||(w?n[0].naturalHeight:n.height()),
g=a.setModalHeight(120,!0);(h>m-g||e>q)&&!0===a.options.fixedHeight&&(g=Math.min((q-100)/e,(m-g)/h),e*=g,h*=g,2<r&&t.addClass("ssi-overHeight"));f.css("height",h);a.options.center&&f.parent().css({width:e,height:h});t.css("width",e);d();t.addClass("ssi-imgBorder")}function g(){if(w){if(0<n[0].naturalWidth){h();return}}else if(clearInterval(B),50<n.width()){h();return}l=!0}var t=a.get$wrapper(),f=t.find("#ssi-modalContent");if(b&&"#"!=b){var B,l,w="naturalWidth"in new Image,m=e(window).height(),q=
e(window).width(),n=[""],r=0;a.options.navigation&&k&&f.append(c);-1!==e.inArray(b.split(".").pop().toLowerCase(),["jpg","jpeg","png","gif","bmp"])?(n=e('<img src="'+b+'" class="ssi-modalImg"/>').on("load",function(){if(!w){var a=new Image;a.src=n.attr("src");h(a.width,a.height)}}).error(function(){var a=k?k.attr("data-alt"):"";n="<h3>Image not found</h3><br>"+("undefined"!==typeof a?"<h4>"+a+"</h4>":"");d(!0)}),g(),l&&(B=setInterval(function(){t.addClass("ssi-imgBorder");g();r++},50))):("boolean"!==
typeof a.options.iframe.allowFullScreen&&(a.options.iframe.allowFullScreen=!0),a.options.iframe.className=a.options.iframe.className||"",n=e('<iframe src="'+b+'" frameborder="0" '+(a.options.iframe.allowFullScreen?"allowfullscreen":"")+"></iframe>"),a.options.center?t.addClass("ssi-iframe ").find("#ssi-modalWindow"+a.numberId).addClass(a.options.iframe.className):t.addClass("ssi-iframe "+a.options.iframe.className),d())}else{var u=k?k.attr("data-alt"):"",n="<h3>Image not found</h3><br>"+("undefined"!==
typeof u?"<h4>"+u+"</h4>":"");d(!0)}}function u(a){a instanceof Array||(a=[a]);return a}var G=function(){var a=!1,b=["Webkit","Moz","O","ms","Khtml"],c="",c=document.createElement("div");void 0!==c.style.animationName&&(a=!0);if(!1===a)for(var d=0;d<b.length;d++)if(void 0!==c.style[b[d]+"AnimationName"]){c=b[d];c.toLowerCase();a=!0;break}return a}(),x=0,y=0,q={stackModal:0,normalModal:0},C=0,m=!1,f=function(a){this.numberId=C;this.pluginName=a.stack?"stackModal":"normalModal";this.backdropId="";this.showbd=
!0;this.setOptions(a)};f.prototype.setOptions=function(a,b){if("object"===typeof a){var c=this;this.options=e.extend(!0,{content:"",bodyScroll:!1,keepContent:!1,position:"",backdrop:!0,stack:!1,onClickClose:!1,bodyElement:!1,className:"",backdropClassName:"",preview:{icon:!1,hideIcons:!1,state:"normal"},closeAfter:!1,outSideClose:!0,onClose:"",onShow:"",beforeClose:"",beforeShow:"",iframe:{allowFullScreen:!0,className:""},center:!1,closeIcon:!0,navigation:!1,sizeClass:"medium",animation:!1,modalAnimation:void 0,
backdropAnimation:void 0,animationSpeed:300,buttons:[],iconButtons:[],title:"",fixedHeight:!1,fitScreen:!1},a);this.options.iconButtons=u(this.options.iconButtons);this.options.preview.icon&&this.options.iconButtons.push({className:"ssi-displayIcon",method:function(){c.changePreviewState()}});this.options.closeIcon&&this.options.iconButtons.push({className:"ssi-closeIcon",method:function(){c.close()}})}else this.options[a]=b;H(this);return this};f.prototype.init=function(){this.options.backdrop&&
this.backdropInit();this.modalInit();C++;return this};f.prototype.get$content=function(){return this.get$modal().find("#ssi-modalContent")};f.prototype.get$modal=function(a){a=a||this.modalId;return this.$modal||e("#"+a)};f.prototype.get$title=function(){return this.get$modal().find("#ssi-modalTitle")};f.prototype.destroyTitle=function(){this.get$title().remove();this.options.title="";return this};f.prototype.destroyContent=function(){this.get$content().remove();this.options.content="";return this};
f.prototype.destroyButtons=function(a){this.get$buttons(a).remove();this.options.buttons=[];return this};f.prototype.destroyIcons=function(){this.get$icons().remove();this.options.icons=[];return this};f.prototype.get$icons=function(){return this.get$modal().find(".ssi-topIcons")};f.prototype.get$buttons=function(a){a=a||"buttons";return this.get$modal().find("#ssi-"+a)};f.prototype.get$window=function(){return this.get$modal().find("#ssi-modalWindow")};f.prototype.get$wrapper=function(){return this.options.stack?
this.get$modal().parent():this.get$modal().find("#ssi-modalWrapper")};f.prototype.get$backdrop=function(){return this.$backdrop||e("#"+this.backdropId)};var D=null;f.prototype.changePreviewState=function(){var a=this.get$modal();if("fullScreen"===this.options.preview.state)a.removeClass("ssi-fullScreen"),this.options.preview.state="normal",a.find("#ssi-modalContent").css("height",""),(this.options.fixedHeight||this.options.fitScreen)&&this.setModalHeight(),clearTimeout(D),a.off("mousemove.ssi-modal");
else{if(this.options.preview.hideIcons){var b=a.find(".ssi-topIcons");if(this.options.buttons)var c=a.find("#ssi-buttons");a.on("mousemove.ssi-modal",function(){clearTimeout(D);b.fadeIn();c.slideDown();D=setTimeout(function(){c.slideUp();b.fadeOut()},2E3)})}this.setModalHeight(40,"height");a.addClass("ssi-fullScreen");this.options.preview.state="fullScreen"}return this};f.prototype.setPluginName=function(a){this.pluginName=a;q[a]=0;return this};f.prototype.setContent=function(a,b){b=b||"html";var c;
!0!==this.options.content?(c=e('<div id="ssi-modalContent" class="ssi-modalContent '+(this.options.fixedHeight?"ssi-overflow ":"")+'"></div>'),""===this.options.content&&(!0===this.options.title?this.get$title().after(c):this.get$window().prepend(c),this.setModalHeight()),this.options.content=!0):c=this.get$content();var d=a;if(a instanceof e&&!0===this.options.bodyElement){if(!0===this.options.extendOriginalContent){var h=this.options.beforeClose;this.options.beforeClose=function(b){var c;"function"===
typeof h&&(c=h(b));if(!1!==c)a.eq(0).after(b.get$content().contents().unwrap().css("display","")).remove();else return c}}d=a.eq(0).clone();d.is(":visible")||d.show()}c[b](d);return c};f.prototype.setButtons=function(a,b){var c,d=!1;a=u(a);!1!==b&&(b="undefined"!==typeof b?e(b):this.get$window(),c=b.find("#ssi-buttons"),c=c[0]);c||(c=e('<div id="ssi-buttons" class="ssi-buttons"><div  id="ssi-leftButtons" class="ssi-leftButtons"></div><div id="ssi-rightButtons" class="ssi-rightButtons"></div></div>'),
...
"anim ssi-fadeOut":"ssi-hidden"},a.options.backdropAnimation={show:"ssi-show"!==a.options.backdropAnimation.show?"anim ssi-fadeIn":"ssi-show",hide:"ssi-hidden"!==a.options.backdropAnimation.hide?"anim ssi-fadeOut":"ssi-hidden"})},I=function(a){var b=a.get$modal();a.time=setTimeout(function(){a.close()},1E3*a.options.closeAfter.time);if(a.options.closeAfter.displayTime&&a.options.title){var c=b.find("span.ssi-displayTime").html(a.options.closeAfter.time);E(a,c,function(){a.$displayTime.remove()})}a.options.closeAfter.resetOnHover&&
...
e(b.target);b.is("a")||b.is("button")||a.close()});0<a.options.iconButtons.length&&d.push(a.setIcons(a.options.iconButtons,!0));d.push(c);"undefined"===typeof a.options.buttons||e.isEmptyObject(a.options.buttons)||d.push(a.setButtons(a.options.buttons,!1));b.append(d);return b};f.prototype.generateButton=function(a){a=e.extend({},{className:"",enableAfter:!1,method:function(){},type:"button",focused:!0,id:"",label:"",modalAnimation:"",backdropAnimation:""},a);var b="button",c="",d=this,h;"link"===
a.type&&(b="a",c=' href="#"');var g=e("<"+b+c+(a.id?' id="'+a.id+'"':" ")+(a.enableAfter?"disabled ":"")+' class="ssi-modalBtn '+(a.className||"")+'">'+a.label+"</"+b+">");if("number"===typeof a.enableAfter){var f=e('<span class="ssi-countDown">'+a.enableAfter+"</span>");E(d,f,function(){g.removeClass("disabled");g.removeAttr("disabled");f.remove()});g.append(f)}if(a.keyPress)e("body").on("keydown.ssi_modal",function(b){b.keyCode!=a.keyPress||g.is(":disabled")||g.trigger("click")});return g.click(function(b){b.preventDefault();
...
"."),d=e("div.ssi-modalOuter.ssi-stack."+d);if(d[0])d.find("#ssi-modalWrapper")[c](a);this.$modal=a}if(!this.options.stack||!d[0]){var h=e('<div id="ssi-modalWrapper" class=" ssi-modalWrapper '+this.options.sizeClass+'"></div>'),f=e('<div class="ssi-modalOuter '+(this.options.stack?" ssi-stack":""+this.options.className)+(this.options.center?" ssi-center ":" ")+" "+(this.options.position?" ssi-modalPositioned "+this.options.position:"")+'"></div>').append(h.append(a)).appendTo(e("body"));this.options.stack||
(this.$modal=f,f.one("onShow.ssi-modal",function(){!0===b.options.outSideClose&&(f.click(function(a){a.target===this&&(a.preventDefault(),b.close())}),h.click(function(a){a.target===this&&(a.preventDefault(),b.close())}))}))}this.modalId="ssi-"+this.pluginName+this.numberId;this.$modal.attr("id","ssi-"+this.pluginName+this.numberId);this.$modal.addClass(this.pluginName+" ssi-modal");this.$modal.data("ssi-modal",this).addClass("ssi-hidden");"string"===typeof m&&this.backdropInit();return this.$modal};
...
y=x=0;q={stackModal:0,normalModal:0};C=0},dialog:function(a,b){var c={sizeClass:"dialog",okBtn:{className:"",label:"Ok"},title:"",closeIcon:!1,outSideClose:!1};a.okBtn=e.extend({},c.okBtn,a.okBtn);a=e.extend({},c,a);a.buttons=[{className:a.okBtn.className,label:a.okBtn.label,closeAfter:!0,method:b}];return(new f(a)).init().show()},confirm:function(a,b){var c={okBtn:{className:"",label:"Ok"},cancelBtn:{className:"",label:"Cancel"},closeIcon:!1,sizeClass:"dialog",title:"",outSideClose:!1};a.okBtn=e.extend({},
c.okBtn,a.okBtn);a.cancelBtn=e.extend({},c.cancelBtn,a.cancelBtn);a=e.extend({},c,a);a.buttons=[{className:a.okBtn.className,label:a.okBtn.label,closeAfter:!0,method:function(a,c){"function"===typeof b&&b(!0,a,c)}},{className:a.cancelBtn.className,label:a.cancelBtn.label,closeAfter:!0,method:function(a,c){"function"===typeof b&&b(!1,a,c)}}];return(new f(a)).init().show()}},A={"ssi-mainOption":{}};l.imgBox=function(a,b){A[b||"ssi-mainOption"]=e.extend({},A["ssi-mainOption"],a)};var p,v,k;l.proto.navigate=
function(a){var b=e('a[data-ssi_imgGroup="'+k.attr("data-ssi_imgGroup")+'"]');p||(p=b.index(k));v||(v=b.length);if("next"===a&&p+1>=v||"prev"===a&&0>p)return this;this.destroyModal();"next"===a?p++:"prev"===a&&p--;b.eq(p).trigger("click.ssi-imgBox");return this};l.imgBox.show=function(a,b){b=e.extend(!0,{backdrop:"byKindShared",fixedHeight:!0,navigation:!0,closeIcon:!0,title:!1,hideImgButtons:!0},b);e.extend(b,{img:!0,content:'<div class="ssi-loader"></div>',sizeClass:""});var c=l.createObject(b).setPluginName("imgBox");
c.imgUrl=a;c.imgTitle=b.title;c.init();b.title&&c.get$icons().addClass("inTitle");c.show();r(c,a)};e("body").on("click.ssi-imgBox","a.ssi-imgBox",function(a){a.preventDefault();a.stopPropagation();k=e(a.currentTarget);a=k.attr("data-ssi_imgGroup")||"ssi-mainOption";a=A[a]||A["ssi-mainOption"];var b=k.attr("href");if(""!==a.imgButtons&&!e.isEmptyObject(a.imgButtons))for(var c=0;c<a.imgButtons.length;c++)if(a.imgButtons[c].exclude)for(var d=a.imgButtons[c].exclude.split(","),f=0;f<d.length;f++)if(k.hasClass(d[f])){a.imgButtons.splice(c,
1);break}a.title&&!0===a.title&&(a.title=k.attr("title"));l.imgBox.show(b,a,k)});l.notify=function(a,b,c){var d={closeIcon:!1,overrideOther:!1,sizeClass:"dialog",onClickClose:!0,bodyScroll:!0,animation:!0,className:"",backdrop:!1,outSideClose:!1,position:"right top",topZIndex:!0,okBtn:{className:"",label:"Ok"},cancelBtn:{className:"",label:"Cancel"},stack:!0,closeAfter:{time:4,resetOnHover:!0}};b.okBtn=e.extend({},d.okBtn,b.okBtn);b.cancelBtn=e.extend({},d.cancelBtn,b.cancelBtn);var f="",g="";switch(a){case "success":d.className=
